...
const DesignPreview: React.FC<DesignPreviewProps> = ({ selectedDesign, onDesignChange }) => {
  const designs = [
    {
      id: 'classic',
      name: 'Classic',
  ...
  return (
    <div className="space-y-4">
            ...
            {designs.map((design) => (
              ...
              >
                <div className="flex flex-col items-center gap-2">
                  <div className="bg-gray-900/50 rounded p-2 min-h-[50px] flex items-center justify-center w-full">
                    {design.preview}
                  </div>
      ...
      <Card className="bg-gray-900/50 border-gray-700/50">
        <CardHeader className="pb-3">
          <CardTitle className="text-white text-base font-medium">Selected: {designs.find(d => d.id === selectedDesign)?.name}</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="bg-gray-800/50 rounded-lg p-6 flex items-center justify-center min-h-[100px]">
