...
const ControlPanel: React.FC<ControlPanelProps> = ({
  ...
  return (
    <div className="space-y-4 h-full overflow-y-auto">
      ...
      <Card className="!bg-[#101010] border-gray-700/50 backdrop-blur-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  updateSetting("startValue", parseInt(e.target.value) || 0)
                }
                className="!bg-[#181818]/80 border-gray-600/50 text-white text-sm h-9 focus:border-blue-500 transition-colors"
              />
            </div>
            <div className="space-y-2">
              <Label className="text-gray-300 text-xs font-medium uppercase tracking-wide">
              ...
              <Input
                ...
                onChange={(e) =>
                  updateSetting("endValue", parseInt(e.target.value) || 100)
                }
                className="!bg-[#181818]/80 border-gray-600/50 text-white text-sm h-9 focus:border-blue-500 transition-colors"
              />
            </div>
      ...
      <Card className="!bg-[#101010] border-gray-700/50 backdrop-blur-sm">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Select
              value={settings.transition || "none"}
              onValueChange={(value) => updateSetting("transition", value)}
            >
              <SelectTrigger className="!bg-[#181818]/80 border-gray-600/50 text-white text-sm h-9 focus:border-purple-500">
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent className="!bg-[#101010] border-gray-600">
                <SelectItem
                  value="classic"
                  className="!bg-[#101010] text-white data-[state=checked]:!bg-[#101010] data-[state=checked]:text-white"
                >
                  Classic
                </SelectItem>
                <SelectItem
      ...
      <Card className="!bg-[#101010] border-gray-700/50 backdrop-blur-sm">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            >
              <SelectTrigger className="!bg-[#181818]/80 border-gray-600/50 text-white text-sm h-9 focus:border-orange-500">
                <SelectValue />
              </SelectTrigger>
              <SelectContent className="!bg-[#101010] border-gray-600">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className="!bg-[#181818]/80 border-gray-600/50 text-white text-sm h-9 focus:border-orange-500 transition-colors"
            />
          </div>
      ...
      <Card className="!bg-[#101010] border-gray-700/50 backdrop-blur-sm">
        ...
        <CardContent>
          <div className="space-y-2">
            ...
            >
              <SelectTrigger className="!bg-[#181818]/80 border-gray-600/50 text-white text-sm h-9 focus:border-pink-500">
                <SelectValue />
              </SelectTrigger>
              <SelectContent className="!bg-[#101010] border-gray-600">
